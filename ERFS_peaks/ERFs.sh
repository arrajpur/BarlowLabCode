...
# 
# Description: Script used to call ERFS peaks
# 	Mostly self-contained. I provide most of 
#	The binaries needed. 
# 	User MUST input correct filenames below
# 	Assumed that you have bowtie2, samtools, bedtools
# 	Output does NOT have blacklist removed. REMEMBER TO DO THIS.
# 	I have a seperate script that will remove blacklist 
#
# 	Copy my convert-everything binary from the binaries/ directoy of this github repo to the current directory
# 

# ====================================================== #
###### YOU MUST PROVIDE THESE FILES AND INPUT NAMES ######
# ====================================================== #

# raw fastq files
# get these from GEO Dataset for the ERFS paper
...
#==============================================#
## DEPRECIATED: BUG FOUND IN read_depth.pl
# using my convert-everything program instead
#==============================================#
...
./convert-everything --clean mm9.chrom --sambin 10 -i $BRCA1_sam -c bg -o $BRCA1_bin
./convert-everything --clean mm9.chrom --sambin 10 -i $RPA_sam -c bg -o $RPA_bin
./convert-everything --clean mm9.chrom --sambin 10 -i $SMC5_sam -c bg -o $SMC5_bin
./convert-everything --clean mm9.chrom --sambin 10 -i $WCE_sam -c bg -o $WCE_bin
